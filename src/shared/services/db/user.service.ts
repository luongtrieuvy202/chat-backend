...
import { IBaseInfo, IUserDocument, ISocialLinks, INotificationSettings, ISearchUser } from 'src/features/user/interfaces/user.interface';
...
class UserService {
  ...
  public async updateUserInfo(userId: string, info: IBaseInfo): Promise<void> {
